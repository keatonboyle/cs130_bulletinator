...
public class PinnedHeaderTrait implements AbsListView.OnScrollListener {
	...
	public void configureHeaderView() {
        ...
        // Fix width of header not being whole row
        headerView.setMinimumWidth(listView.getWidth());
       ...
       // Fix warnings
        if(android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.JELLY_BEAN) {
        	...
        	headerView.setBackground(headerView.getContext().getResources().getDrawable(R.drawable.underline));
        }
